...
export const translations = {
  fr: {
    ...
    form_v_count: "Voyageurs",
    form_v_adults: "Adultes",
    form_v_child1: "1er Enfant",
    form_v_child2: "2ème Enfant",
    form_v_baby: "Bébé",
    form_message: "Message ou Questions",
    form_counselor: "Conseiller WhatsApp",
  ...
  ar: {
    ...
    form_v_count: "المسافرين",
    form_v_adults: "بالغين",
    form_v_child1: "الطفل الأول",
    form_v_child2: "الطفل الثاني",
    form_v_baby: "رضيع",
    form_message: "رسالة أو أسئلة",
    form_counselor: "مستشار واتساب",
